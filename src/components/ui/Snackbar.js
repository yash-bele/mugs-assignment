    ...
    <AnimatePresence>
      {openSnackbar && (
        <motion.div
          ...
          className={`fixed z-30 top-2.5 sm:top-5 left-0 sm:left-auto right-0 sm:right-5 mx-auto sm:mx-0 w-fit rounded-xl h-10 px-2.5 pb-px border text-black font-medium flex items-center ${
            type === "warning"
